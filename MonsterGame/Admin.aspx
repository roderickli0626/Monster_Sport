<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="MonsterGame.Admin" %>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 col-xl-6 text-center">
                    <h2 class="title text-white">Admin</h2>
                            ...
                            <div class="modal-body modal--body">
                                ...
                                <asp:UpdatePanel runat="server" ID="UpdatePanel" ClientIDMode="Static" class="row gy-3">
                                    <ContentTemplate>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="TxtTitle" class="form-label">NickName</label>
